...
Route::middleware('auth:api')->group(function () {
    ...
    Route::prefix('sertifikat')->group(function () {
        Route::get('/', [SertifikatController::class, 'index']);           // List semua sertifikat
        Route::get('/{id}', [SertifikatController::class, 'show']);        // View/Download sertifikat
        Route::get('/{id}/download', [SertifikatController::class, 'download']); // Force download (opsional)
    });
    ...
    Route::prefix('user/ujians')->group(function () {
        Route::get('/', [UserUjianController::class, 'index']);                         // List ujian user
        ...
        Route::get('{id}/soal', [UserUjianController::class, 'getSoalUjian']);          // Ambil soal ujian
        Route::post('{id}/jawaban', [UserUjianController::class, 'simpanJawaban']);     // Simpan jawaban
        Route::post('{id}/submit', [UserUjianController::class, 'submitUjian']);        // Submit ujian
        Route::post('{id}/ulang', [UserUjianController::class, 'ulangUjian']);          // Ulang ujian
        Route::get('{id}/hasil', [UserUjianController::class, 'hasilUjian']);           // Hasil ujian
        Route::get('{id}/riwayat', [UserUjianController::class, 'getRiwayatUjian']);    // Riwayat ujian
    });
